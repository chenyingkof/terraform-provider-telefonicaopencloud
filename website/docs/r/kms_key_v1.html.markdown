...
page_title: "TelefonicaopenCloud: telefonicaopencloud_kms-key-v1"
sidebar_current: "docs-telefonicaopencloud-resource-kms-key-v1"
description: |-
...
```hcl
resource "telefonicaopencloud_kms_key_v1" "key_1" {
  key_alias       = "key_1"
  pending_days    = "7"
...
```
$ terraform import telefonicaopencloud_kms_key_v1.key_1 7056d636-ac60-4663-8a6c-82d3c32c1c64
```
